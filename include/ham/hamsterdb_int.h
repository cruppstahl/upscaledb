 ...
 */
typedef ham_status_t (*ham_page_filter_pre_cb_t)(ham_page_filter_t *filter, 
 ...
 */
typedef ham_status_t (*ham_page_filter_post_cb_t)(ham_page_filter_t *filter, 
        ham_u8_t *page_data, ham_size_t page_size);
 ...
 */
typedef void (*ham_page_filter_close_cb_t)(ham_page_filter_t *filter);
