...
sh short.sh --cachesize=0 --inmemorydb=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=0 --overwrite=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=0 --inmemorydb=1 --overwrite=1 $1 $2 $3 $4 $5
...
sh short.sh --cachesize=50 --inmemorydb=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=50 --overwrite=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=50 --inmemorydb=1 --overwrite=1 $1 $2 $3 $4 $5
...
sh short.sh --cachesize=1048576 --inmemorydb=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=1048576 --overwrite=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=1048576 --inmemorydb=1 --overwrite=1 $1 $2 $3 $4 $5
...
sh short.sh --cachepolicy=strict --inmemorydb=1 $1 $2 $3 $4 $5
sh short.sh --cachepolicy=strict --overwrite=1 $1 $2 $3 $4 $5
sh short.sh --cachepolicy=strict --inmemorydb=1 --overwrite=1 $1 $2 $3 $4 $5
...
sh short.sh --cachesize=1024 --cachepolicy=strict --inmemorydb=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=1024 --cachepolicy=strict --overwrite=1 $1 $2 $3 $4 $5
sh short.sh --cachesize=1024 --cachepolicy=strict --inmemorydb=1 --overwrite=1 $1 $2 $3 $4 $5
