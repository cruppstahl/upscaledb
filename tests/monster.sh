...
./run-tests.sh $d --optimizesize=1 --inmemorydb=1 $1 $2 $3 $4 $5
./run-tests.sh $d --optimizesize=1 --overwrite=1 --inmemorydb=1 $1 $2 $3 $4 $5
...
./run-tests.sh $d --keysize=12 --overwrite=1 --reopen=1 --optimizesize=1 $1 $2 $3 $4 $5
...
./run-tests.sh $d --keysize=33 --overwrite=1 --reopen=1 --optimizesize=1 $1 $2 $3 $4 $5
...
./run-tests.sh $d --keysize=680 --overwrite=1 --reopen=1 --optimizesize=1 $1 $2 $3 $4 $5
...
./run-tests.sh $d --pagesize=1024 --overwrite=1 --reopen=1 --optimizesize=1 $1 $2 $3 $4 $5
