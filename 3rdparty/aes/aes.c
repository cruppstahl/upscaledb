 ...
 * and tables as "static", changing the number of rounds to 1 (for performance
 * reasons), removing the example code and main function, renaming some
 * functions and adding the header file and the autoconf files.
 *              --- Christoph Rupp, Sun Oct 21 21:54:44 CEST 2007
 *
 */
