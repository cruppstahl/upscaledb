...
#ifndef HAM_BTREE_KEYS_VARLEN_H__
#define HAM_BTREE_KEYS_VARLEN_H__
...
class VariableLengthKeyList : public BaseKeyList
{
  ...
  public:
    ...
    VariableLengthKeyList(LocalDatabase *db)
      : m_db(db), m_index(db), m_data(0), m_extkey_cache(0), m_compressor(0) {
      int algo = m_db->get_key_compression_algorithm();
      if (algo)
...
#endif /* HAM_BTREE_KEYS_VARLEN_H__ */
