 ...
 *
 * This header file provides these forward declarations to prevent several cyclic
 * dependencies; in particular, the @ref ham_page_t is a type used throughout, but
 * a @ref ham_page_t contains several other types, which again reference 
 * @ref ham_page_t pointers either directly or indirectly.
 *
