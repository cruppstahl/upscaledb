...
class EndianTest : public hamsterDB_fixture
{
  ...
  public:
    void byteswap16() {
      BFC_ASSERT_EQUAL(0x3412, _ham_byteswap16(0x1234));
      BFC_ASSERT_EQUAL(0xafbc, _ham_byteswap16(0xbcaf));
      BFC_ASSERT_EQUAL(0x0000, _ham_byteswap16(0x0000));
      BFC_ASSERT_EQUAL(0xffff, _ham_byteswap16(0xffff));
    }

    void byteswap32() {
      BFC_ASSERT_EQUAL((unsigned int)0x78563412, _ham_byteswap32(0x12345678));
      BFC_ASSERT_EQUAL((unsigned int)0xafbc1324, _ham_byteswap32(0x2413bcaf));
      BFC_ASSERT_EQUAL((unsigned int)0x00000000, _ham_byteswap32(0x00000000));
      BFC_ASSERT_EQUAL((unsigned int)0xffffffff, _ham_byteswap32(0xffffffff));
    }
    ...
    void byteswapTwice16() {
      ...
      for (int i = 0; i < 4; i++) {
        ...
        BFC_ASSERT_EQUAL(orig, (unsigned short)_ham_byteswap16(swapped));
      }
    }
    ...
    void byteswapTwice32() {
      ...
      for (int i = 0; i < 4; i++) {
        ...
        BFC_ASSERT_EQUAL(orig, (unsigned int)_ham_byteswap32(swapped));
      }
    }
    ...
    void byteswapTwice64() {
      ...
      for (int i = 0; i < 4; i++) {
        ...
        BFC_ASSERT_EQUAL(orig, (unsigned long long)_ham_byteswap64(swapped));
      }
    }
};
