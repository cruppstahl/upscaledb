...
public:
  HamsterdbTest()
    ...
    BFC_REGISTER_TEST(HamsterdbTest, negativeInsertBigKeyTest);
...
#undef PREP
  ...
  void insertBigKeyTest() {
    ...
    teardown();
    BFC_ASSERT_EQUAL(0, ham_env_create(&m_env, "test.db", 0, 0644, 0));
    BFC_ASSERT_EQUAL(0,
    ...
    BFC_ASSERT_EQUAL(0, ham_env_open(&m_env, "test.db", 0, 0));
    BFC_ASSERT_EQUAL(0,
