...
namespace Hamster
{
    internal sealed class NativeMethods
    {
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_set_errhandler",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern void SetErrorHandler(ErrorHandler eh);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_strerror",
            CallingConvention=CallingConvention.Cdecl)]
        static public extern String StringError(int error);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_get_version",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern void GetVersion(out int major, out int minor,
                out int revision);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_get_license",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern void GetLicense(out String licensee,
                out String product);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_new",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern int NewEnvironmentHandle(out IntPtr handle);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_delete",
            CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_open_db",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnvOpenDatabase(IntPtr handle, IntPtr dbhandle,
                short name, int flags, Parameter[] parameters);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_rename_db",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnvRenameDatabase(IntPtr handle,
                short oldName, short newName);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_erase_db",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnvEraseDatabase(IntPtr handle,
                short name, int flags);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_flush",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnvFlush(IntPtr handle, int flags);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_get_database_names",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_env_close",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_txn_commit",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int TxnCommit(IntPtr handle, int flags);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_txn_abort",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int TxnAbort(IntPtr handle, int flags);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_new",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern int NewDatabaseHandle(out IntPtr handle);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_delete",
            CallingConvention = CallingConvention.Cdecl)]
...
*/
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_move",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_overwrite",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_find",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_insert",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_erase",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int CursorErase(IntPtr handle, int flags);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_get_duplicate_count",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int CursorGetDuplicateCount(IntPtr handle, out int count,
                int flags);

        [DllImport("hamsterdb-2.0.5.dll", EntryPoint = "ham_cursor_close",
           CallingConvention = CallingConvention.Cdecl)]
