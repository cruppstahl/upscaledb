...
/*
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_get_parameters",
       CallingConvention = CallingConvention.Cdecl)]
    static public extern int GetParameters(IntPtr handle, Parameter[] parameters);
*/

    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_get_env",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    // marshalling. if you need this function pls drop me a mail.
/*
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_key_get_approximate_match",
       CallingConvention = CallingConvention.Cdecl)]
...
*/
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_set_compare_func",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_set_prefix_compare_func",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_set_duplicate_compare_func",
       CallingConvention = CallingConvention.Cdecl)]
    static public extern int SetDuplicateCompareFunc(IntPtr handle,
        NativeMethods.DuplicateCompareFunc foo);

    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_find",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_insert",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_db_erase",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_cursor_overwrite",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_cursor_find",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_cursor_insert",
       CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_cursor_erase",
       CallingConvention = CallingConvention.Cdecl)]
    static public extern int CursorErase(IntPtr handle, int flags);

    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_cursor_get_duplicate_count",
       CallingConvention = CallingConvention.Cdecl)]
    static public extern int CursorGetDuplicateCount(IntPtr handle, out int count,
        int flags);

    [DllImport("hamsterdb-2.1.2.dll", EntryPoint = "ham_cursor_close",
       CallingConvention = CallingConvention.Cdecl)]
