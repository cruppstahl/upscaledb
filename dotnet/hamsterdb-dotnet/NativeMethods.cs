...
namespace Hamster
{
    internal sealed class NativeMethods
    {
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_set_errhandler", 
            CallingConvention = CallingConvention.Cdecl)]
        static public extern void SetErrorHandler(ErrorHandler eh);
        
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_strerror",
            CallingConvention=CallingConvention.Cdecl)]
        static public extern String StringError(int error);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_get_version",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern void GetVersion(out int major, out int minor,
                out int revision);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_get_license",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern void GetLicense(out String licensee,
                out String product);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_env_new",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern int NewEnvironmentHandle(out IntPtr handle);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_env_delete",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern void DeleteEnvironmentHandle(IntPtr handle);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_env_create_ex",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnvCreate(IntPtr handle, String fileName, int flags,
                int mode, Parameter[] parameters);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_env_open_ex",
           CallingConvention = CallingConvention.Cdecl)]
...
*/
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_env_close",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnvClose(IntPtr handle, int flags);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_env_enable_encryption",
           CallingConvention = CallingConvention.Cdecl)]
...
// TODO this is new
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_new",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern int NewDatabaseHandle(out IntPtr handle);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_delete",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern void DeleteDatabaseHandle(IntPtr handle);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_get_error",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern int GetLastError(IntPtr handle);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_create_ex",
            CallingConvention = CallingConvention.Cdecl)]
        static public extern int Create(IntPtr handle, String fileName, int flags,
                int mode, Parameter[] parameters);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_open_ex",
            CallingConvention = CallingConvention.Cdecl)]
        ...
        // marshalling. if you need this function pls drop me a mail.
/*
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_get_parameters",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int GetParameters(IntPtr handle, Parameter[] parameters);
*/

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_get_env",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        // marshalling. if you need this function pls drop me a mail.
/*
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_key_get_approximate_match",
           CallingConvention = CallingConvention.Cdecl)]
...
*/
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_set_compare_func",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_set_prefix_compare_func",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_set_duplicate_compare_func",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int SetDuplicateCompareFunc(IntPtr handle,
                NativeMethods.DuplicateCompareFunc foo);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_enable_compression",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int EnableCompression(IntPtr handle, int level);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_find",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_insert",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_erase",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_cursor_overwrite",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_cursor_find",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_cursor_insert",
           CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_cursor_erase",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int CursorErase(IntPtr handle, int flags);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_cursor_get_duplicate_count",
           CallingConvention = CallingConvention.Cdecl)]
        static public extern int CursorGetDuplicateCount(IntPtr handle, out int count,
                int flags);

        [DllImport("hamsterdb-2.0.0.rc4.dll", EntryPoint = "ham_cursor_close",
           CallingConvention = CallingConvention.Cdecl)]
